...
<head>
    ...
    <title>{{ config('app.name', 'Point of Sales') }} - Toko Terpercaya</title>
        ...
        <div class="mb-12 text-center">
            ...
            <div class="mb-8">
                ...
                <h1 class="mb-4 text-4xl font-bold text-gray-800 md:text-6xl">
                    <span class="text-blue-600">Point</span> of <span class="text-indigo-600">Sales</span>
                </h1>
            ...
            <div class="grid gap-8 mb-12 md:grid-cols-3">
                <div class="p-6 transition-shadow bg-white shadow-lg rounded-xl hover:shadow-xl">
                    ...
                    <h3 class="mb-2 text-lg font-semibold text-gray-800">Manajemen Produk</h3>
                    <p class="text-gray-600">Kelola stok dan produk dengan mudah dan efisien</p>
                </div>
                ...
                <div class="p-6 transition-shadow bg-white shadow-lg rounded-xl hover:shadow-xl">
                    ...
                    <h3 class="mb-2 text-lg font-semibold text-gray-800">Laporan Penjualan</h3>
                    <p class="text-gray-600">Analisis penjualan real-time untuk bisnis yang lebih baik</p>
                </div>
                ...
                <div class="p-6 transition-shadow bg-white shadow-lg rounded-xl hover:shadow-xl">
                    ...
                    <h3 class="mb-2 text-lg font-semibold text-gray-800">Multi User</h3>
                    <p class="text-gray-600">Sistem dengan berbagai role untuk keamanan optimal</p>
                </div>
            </div>
